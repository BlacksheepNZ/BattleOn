...
namespace BattleOn
{
    ...
    [Copyable]
    public class TrackableSet<T> : ITrackableCollection<T>
    {
        ...
        public TrackableSet<T> Initialize(INotifyChangeTracker changeTracker)
        {
    ...
    [Copyable]
    public class TrackableList<T> : ITrackableCollection<T>, IList<T>
    {
        ...
        public TrackableList<T> Initialize(INotifyChangeTracker changeTracker)
        {
            _changeTracker = changeTracker;
            return this;
        }
    ...
    public class Trackable<T> : ITrackableValue<T>
    {
        ...
        public Trackable<T> Initialize(INotifyChangeTracker changeTracker)
        {
            _changeTracker = changeTracker;
            return this;
        }
