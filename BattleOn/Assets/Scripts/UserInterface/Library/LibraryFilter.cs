...
{
    public class LibraryFilter : GameScreen
    {
        ...
        public LibraryFilter(IEnumerable<CardInfo> cards, Func<CardInfo, object> transformResult, Func<CardInfo, int> orderBy)
        {
            _orderBy = orderBy;
        ...
        {
            LibraryFilter Create(IEnumerable<CardInfo> cards, Func<CardInfo, object> transformResult, Func<CardInfo, int> orderBy);
        }
