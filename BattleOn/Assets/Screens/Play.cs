...
namespace BattleOnGame
{
    public class Play : GameScreen,
      IReceive<SpellCastEvent>,
      //IReceive<AbilityActivatedEvent>, IReceive<SearchStartedEvent>, IReceive<SearchFinishedEvent>, 
      IReceive<DamageDealtEvent>,
      IReceive<AssignedDamageDealtEvent>, IReceive<CardWasRevealedEvent>, 
      IReceive<PlayerFlippedCoinEvent>, IReceive<OptionsChosenEvent>, 
      IReceive<TurnStartedEvent>, IReceive<ZoneChangedEvent>, IReceive<LifeChangedEvent>,
